    ...
    if(data.uid)
    {
        ...
        storage.get('sel_format', function(error, data) {
            ...
            if(data.sel_format && (user_id !== undefined))
            {
                ...
                let saved_d1 = db.ref(user_id+"/saved_formats/D10");
                saved_d1.once("value", function(snapshot) {
                    ...
                    saved_d1.child(sel_for+"/data").once("value", function(snapshot) {
                        snapshot.forEach(function (childSnapshot) {
                            ...
                            let inputOI= childSnapshot.child("inputOI").val();
                            let inputRePPC= childSnapshot.child("inputRePPC").val();
        ...
        $('#add_row').click(async () => {
            ...
            )
            {
                ...
                let ref = db.ref(user_id+"/saved_formats/D10");
        ...
        $('#print_preview').click(() => {
            ...
            win.loadURL(`file://${__dirname}/pr_d10.html`);
